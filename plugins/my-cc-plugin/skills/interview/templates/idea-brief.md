...
feature_size: <XS|S|M|L|XL>     # set at a later stage, not here
stage: "01"
...
<!-- Anti-pattern enforcement (Claude self-check, not user-visible):
     Forbidden terms in the body: Postgres, Redis, Kafka, specific library names,
     SM-2/FSRS/Leitner, table schemas, API endpoints, latency targets, SLOs.
     This is a PRODUCT brief. Tech lives in PRD §6 + the architecture doc + ADR (gate 3+). -->
...
**Locked-in pointer**: <what this commits us to for the PRD phase>
